...
import axios from 'axios' // for api caling
...
const Reservation = () => {
    ...
    const handleReservation = async (e) => {
        ...
        try {
            const { data } = await axios.post("http://localhost:3000/api/v2/reservation/send",
            ...
            navigate("/success"); // after this it will redirect to success page
        } catch(error){
